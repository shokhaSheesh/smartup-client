...
export default function DoverennostForm({ docType, onDocType }: { docType: string; onDocType: (v: string) => void }) {
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card>
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
          ...
          <div><h4 className="mb-3 text-lg font-semibold text-slate-800">Компания</h4><OrgFields own /></div>
          <div><h4 className="mb-3 text-lg font-semibold text-slate-800">Компания партнера</h4><OrgFields own={false} /></div>
        </div>
      </Card>
